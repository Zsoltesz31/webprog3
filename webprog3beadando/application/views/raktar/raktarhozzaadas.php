...
<?php echo validation_errors();?>
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="raktar_nev" aria-describedby="emailHelp" placeholder="Raktár név">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Ország</label>
    <input type="text" class="form-control" name="raktar_orszag" placeholder="Ország">
  </div>
  <div class="form-group">
