...
<html lang="hu">
  ...
  <div class="container">
    ...
    <p class="lead">Munkások listája</p>
  </div>
</div>
<?php if($records == null || empty($records)): ?>
    <div class="alert alert-danger" role="alert">
  Nem található munkás az adatbázisban!
</div>
...
<?php else: ?>
    ...
    <?php endforeach; ?>
    <?php endif; ?>
    <?php echo anchor(base_url('munkasok/insert/'), 'Hozzáad'); ?>
    <table class="table">
        <thead>
        <tr>
        ...
        <tbody>
            ...
            <tr>
                <td><?=$record->vezeteknev?></td>
                <td><?=$record->keresztnev?></td>
                <td><?=$record->nev?></td>
            </tr>
            <?php endforeach; ?>
        </tbody>
