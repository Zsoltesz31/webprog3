...
<html lang="hu">
  ...
  <div class="container">
    <h1 class="display-4">Szállítócég hozzáadása</h1>
    <p class="lead">Adjon hozzá új szállítócéget az adatbázishoz</p>
  </div>
</div>
<form method="POST">
<?php echo validation_errors();?>
  <div class="form-group">
    <label for="exampleInputEmail1">Szállítócég neve</label>
    <input type="text" class="form-control" name="szallitoceg_nev" aria-describedby="emailHelp" placeholder="Raktár név">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Raktározott termék</label>
    <select class="form-control" name="szallitoceg_szallithatotermek">
